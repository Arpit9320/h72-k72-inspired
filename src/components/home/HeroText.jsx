...
const HeroText = () => {
  return (
    <div className="text-white font-[font1] ">
        ...
        <div className="lg:text-[9.5vw] text-[12.5vw] lg:leading-[9vw] leading-[12vw] uppercase flex items-center justify-center">qui <div className="h-[7vw] w-[17vw] rounded-full overflow-hidden mb-2 select-none"><HeroVideo/></div> génère</div>
